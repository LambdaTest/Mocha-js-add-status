# Run Mocha Add Status Tests on TestMu AI (Formerly LambdaTest)
...
If you want to add test status in automation test in Mocha.js on TestMu AI (Formerly TestMu AI (Formerly LambdaTest)), you can follow the below steps. You can refer to sample test repo [here](https://github.com/LambdaTest/Mocha-selenium-sample).
