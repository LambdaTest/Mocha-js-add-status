# Mark Pass/Fail Status in Mocha Tests on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can mark Pass/Fail Status in Mocha Tests across real browsers and operating systems.
